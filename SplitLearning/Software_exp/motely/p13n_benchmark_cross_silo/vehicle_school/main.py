...
from trainers.fedavg_odd import FedAvgODD
...
def read_options():
    ...
    parser.add_argument('--trainer',
                        ...
                        type=str,
                        choices=('local', 'fedavg', 'finetune', 'ifca',  'mocha', 'ditto', 'mrmtl', 'knnper','fedavg_odd'),
                        default='fedavg')
    # Datasets
...
def main(options, run_idx=None):
    ...
    elif options['trainer']=='fedavg_odd':
        trainer= FedAvgODD(options,dataset)
