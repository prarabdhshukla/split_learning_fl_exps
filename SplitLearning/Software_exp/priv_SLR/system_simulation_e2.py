...
if __name__ == "__main__":    
    ...
    for epoch in range(args.epochs):
        ...
        for _ in range(num_dropoff):
            ...
            temp = int(random.uniform(0,(num_clients-1)))
            
            if temp not in drop_clients_ids:
                drop_clients_ids.append(temp)
        ...
        print("Drop client ids", drop_clients_ids)
            ...
            with torch.no_grad():
                ...
                for i,(client_id, client) in enumerate(clients.items()):
                    ...
                    if i not in drop_clients_ids:
                        ...
                        print("client test ", client.test_acc[-1])

                print(len(client_ids) - num_dropoff)
                overall_test_acc[-1] /= (len(client_ids) - num_dropoff)

                # overall_test_acc[-1] /= (len(client_ids))
