...
def dataset_iid(dataset, num_users):
    ...
    per_class_client=int(args.datapoints/num_of_classes)
...
def dataset_iid_test(dataset, num_users):
...
if __name__ == "__main__":    
    ...
    train_dataset_size, input_channels = split_dataset(args.dataset, client_ids)
    ...
    print(args.dataset)
    train_full_dataset, test_full_dataset, input_channels= datasets.load_full_dataset(args.dataset, "data")

    #----------------------------------------------------------------
    dict_users = dataset_iid(train_full_dataset,         args.number_of_clients)
    dict_users2 = dataset_iid_test(test_full_dataset,args.number_of_clients)
    i=0
    ...
    for _, client in clients.items():
        ...
        # client.front_model = model.front(input_channels)
