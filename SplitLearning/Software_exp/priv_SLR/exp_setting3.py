...
if __name__ == "__main__":    
    ...
    print("initial length: ", len(test_full_dataset))
    #----------------------------------------------------------------
    ...
    print("final length: ", len(test_full_dataset))
    ...
    for _, client in clients.items():
        dict_user_train[_]=dict_users[i]
        dict_user_test[_]=dict_users2[i]
        client_idxs[_]=i
        i+=1
    for _, client in clients.items():
    ...
    ditto_client_id = client_ids[0]
    ditto_client = clients[ditto_client_id]
    ...
    ditto_client.ditto_front_model = model.front(input_channels, pretrained=args.pretrained)
    ditto_client.ditto_back_model = model.back(pretrained=args.pretrained)
    ...
    ditto_client.ditto_front_opt = optim.Adam(ditto_client.ditto_front_model.parameters(), lr=args.lr)
    ditto_client.ditto_back_opt = optim.Adam(ditto_client.ditto_back_model.parameters(), lr=args.lr)
    ...
    sc_clients[ditto_client_id].ditto_center_model = model.center(pretrained=args.pretrained)
    sc_clients[ditto_client_id].ditto_center_model.center_model.to(device)
    sc_clients[ditto_client_id].ditto_center_optimizer = optim.Adam(sc_clients[ditto_client_id].ditto_center_model.parameters(), args.lr)
